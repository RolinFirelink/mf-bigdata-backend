...
import com.arg.smart.web.price.entity.AveragePrice;
import com.arg.smart.web.price.req.ReqAveragePrice;
import com.arg.smart.web.price.service.AveragePriceService;
...
public class AveragePriceController {
	...
	@ApiOperation("均价表-添加")
	@PostMapping
	public Result<AveragePrice> add(@RequestBody AveragePrice averagePrice) {
		if (averagePriceService.save(averagePrice)) {
			return Result.ok(averagePrice, "均价表-添加成功!");
		}
        return Result.fail(averagePrice, "错误:均价表-添加失败!");
	}
