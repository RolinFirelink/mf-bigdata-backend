...
CREATE TABLE `sh_company`  (
  ...
  `company_no` varchar(255) NOT NULL DEFAULT '' COMMENT '公司编码',
  `juridical_person` varchar(50) NULL DEFAULT NULL COMMENT '法人',
  `juridical_phone` varchar(30) NULL DEFAULT NULL COMMENT '法人电话',
  `contacts` varchar(100) NULL DEFAULT NULL COMMENT '联系人',
  ...
  `address` varchar(50) NULL DEFAULT NULL COMMENT '公司地址',
  `company_type` varchar(20) NOT NULL COMMENT '公司类型(1=企业、2=供货商、3=销售商、4=承运商）',
  `product_type` varchar(20) NOT NULL DEFAULT '1' COMMENT '公司产品类型(1=肉鸡、2=柑橘、3=兰花、4=对虾、5=菜心、6=预制菜)',
...
CREATE TABLE `sh_product_base`  (
    `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
    `company_name` varchar(255) NOT NULL COMMENT '基地名称',
    `company_no` varchar(255) NOT NULL DEFAULT '' COMMENT '基地编码',
    `contacts` varchar(100) NULL DEFAULT NULL COMMENT '联系人',
    `contact_phone` varchar(30) NULL DEFAULT NULL COMMENT '联系电话',
    ...
    `extend_field` longtext NULL COMMENT '自定义拓展字段JSON 结构',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '基地信息表' ROW_FORMAT = Dynamic;
SET FOREIGN_KEY_CHECKS = 1;
